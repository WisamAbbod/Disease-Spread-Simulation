...
public class SceneVars : MonoBehaviour
{
    ...
    [Header("Simulation parameters")]   //simulation variables
    public static int TotalBlobs;
    ...
    [Header("Virus Parameters")]  //virus variables
    public int PCInfected = 20;
    public static int ImmunityPeriod = 7;
    public static float RecoveryPeriod =7;
    public float InfectiousPeriod = 20;
    public static int InfectionProb = 33;
    ...
    [Header("Self Isolation")]                  //isolation period values
    ...
    [Header("Percentage and report calcs")]     //percentages
    ...
    void Awake()
    {
        InputFieldpop cv = go.GetComponent<InputFieldpop>();
        //manager = FindObjectOfType<InputFieldpop>().gameObject;
        TotalBlobs = cv.populateInt;
        //TotalBlobs = ReturnPopulationValue();
    }
    void Start()
    {
   ...
   /* public int ReturnPopulationValue()
    {
        return manager.GetComponent<InputFieldpop>().populateInt;
    }*/
}
